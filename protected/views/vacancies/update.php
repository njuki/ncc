...
$this->breadcrumbs=array(
	...
	$model->vacancyID=>array('view','id'=>$model->vacancyID),
	'Update',
);
...
$this->menu=array(
	...
	array('label'=>'View Vacancies', 'url'=>array('view', 'id'=>$model->vacancyID)),
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title">
				<i class="fa fa-bar-chart-o"></i> Update Vacancy <?php echo $model->job->jobTitle; ?>'s Details
			</h3>
		</div>
